    ...
    <section className=" py-5 bg-[#ddd] flex flex-col space-y-10 pb-24">
      ...
      <div className=" container flex flex-col space-y-7">
        ...
        <div className="flex flex-col space-y-7 text-xl">
         ...
         <Link href="https://cutt.ly/qe1slUTX" target="_blank" className=" bg-white flex   items-center space-x-2 p-4 rounded-xl max-w-[600px] border shadow group ">
         <Image src={FiverrGig} alt="Fiverr Gig"  placeholder="blur" className=" w-[150px] col-span-1 rounded"/>
            <div className=" col-span-3">
              <h5 className=" font-bold text-sm xl:text-lg group-hover:text-red-500">Shahjalalk: I will create html email signature and email footer for...</h5>
