...
const SmHeaderMenu = ({ smMenu, showHeader}: Props) => {
  return (
    <ul className={` ${smMenu ? 'flex' : 'hidden' }   xl:hidden flex-col space-y-5 h-screen bg-slate-500 fixed right-0 w-[70%] z-40 px-3 py-7 border rounded-md ${showHeader ? 'translate-x-0' : 'translate-x-[300px] lg:translate-x-[800px]' }  transition-all duration-300`}>
    <li className="flex">
