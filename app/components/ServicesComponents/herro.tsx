    ...
    <section className="section-padding relative" id='home'>
        <div className="container grid grid-cols-1 xl:grid-cols-2 gap-y-10 xl:gap-y-0 xl:gap-x-10">
            <div className="flex flex-col space-y-3 ">
                <h1 className="text-3xl font-bold text-titleColor">Stand Out with Professional Clickable Email Signatures</h1>
              ...
              <Link href="#portfolio" className="bg-titleColor hover:bg-dipTigleColor  px-4 lg:px-6 py-4 rounded text-sm lg:text-base uppercase text-white shadow">View Portfolio</Link>
